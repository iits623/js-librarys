...
const checkAllInputs = () => {
    ...
    const password = bundle.chkInp(/[a-zA-Z0-9]/, passwordInput.value)
...
const validateAllInputs = () => {
    ...
    const password = validateInputs(passwordInput, /[a-zA-Z0-9]/, "successful", "Please enter your email correctly")
...
passwordInput.addEventListener("keyup", (e) => validateInputs(e.target, /[a-zA-Z0-9]/, "successful", "Please enter your password correctly"))
